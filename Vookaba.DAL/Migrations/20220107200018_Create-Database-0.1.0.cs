...
namespace Vookaba.DAL.Migrations
{
    public partial class CreateDatabase010 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.SqlFromResource("Vookaba.DAL.Migrations.Sql.00_up_triggers.sql");
            migrationBuilder.SqlFromResource("Vookaba.DAL.Migrations.Sql.01_up_views.sql");
            migrationBuilder.SqlFromResource("Vookaba.DAL.Migrations.Sql.02_up_procedures.sql");
        }

        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.SqlFromResource("Vookaba.DAL.Migrations.Sql.02_down_procedures.sql");
            migrationBuilder.SqlFromResource("Vookaba.DAL.Migrations.Sql.01_down_views.sql");
            migrationBuilder.SqlFromResource("Vookaba.DAL.Migrations.Sql.00_down_triggers.sql");
