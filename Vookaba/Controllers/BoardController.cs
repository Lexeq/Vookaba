...
namespace Vookaba.Controllers
{
    ...
    public class BoardController : AppMvcBaseController
    {
        ...
        public async Task<IActionResult> Index([FromRoute(Name = "board")] string boardKey, int page = 1)
        {
            ...
            if (board == null ||
                board.IsDisabled && !User.IsInRole(ApplicationConstants.Roles.Administrator))
            {
        ...
        [HttpGet]
        [Authorize(Policy = ApplicationConstants.Policies.CanEditBoards)]
