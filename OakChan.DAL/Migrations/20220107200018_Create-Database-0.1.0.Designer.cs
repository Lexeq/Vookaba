...
namespace OakChan.DAL.Migrations
{
    ...
    [Migration("20220107200018_Create-Database-0.1.0")]
    partial class CreateDatabase010
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OakChan.DAL.Entities.ModAction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("OakChan.Identity.ApplicationInvitation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OakChan.Identity.ApplicationInvitation", b =>
                {
                    b.HasOne("OakChan.Identity.ApplicationUser", "Publisher")
                        .WithMany()
                        .HasForeignKey("PublisherId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OakChan.Identity.ApplicationUser", "UsedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("OakChan.Identity.ApplicationUser", b =>
                {
                    b.HasOne("OakChan.DAL.Entities.AuthorToken", "AuthorToken")
                        .WithOne()
                        .HasForeignKey("OakChan.Identity.ApplicationUser", "AuthorTokenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
